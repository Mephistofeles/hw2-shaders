...
# BADGE REMOVED AS IT IS CURRENTLY IMPOSSIBLE TO IMPLIMENT THE EQUIVALENT PER PIXEL SHADER
...
TEMP temp;
TEMP texDiff, texGlow, texBadge, texMask;
TEMP normal;
...
TEX texBadge, texPos, texture[2], 2D;
TEX texMask, texPos, texture[3], 2D;
...
# apply the badge
#SUB temp.a, misc.z, texMask.a;
#MUL temp.rgb, texBadge, temp.a;
#MUL temp.a, temp.a, texBadge.a;
#LRP colour.rgb, temp.a, temp, colour;
